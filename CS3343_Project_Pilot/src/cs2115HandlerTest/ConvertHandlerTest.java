...
public class ConvertHandlerTest {
	...
	public void testGeneral_00() {
		String res = ConvertHandler.convertTo(2, 10);
		assertEquals("1010",res);
	}
	
	@Test
	public void testGeneral_01() {
		String res = ConvertHandler.convertTo(16, 10);
		assertEquals("A",res);
	}
	
	@Test
	public void testGeneral_02() {
		String res = ConvertHandler.convertTo(2, 10.5);
		assertEquals("1010.1",res);
	}
	
	@Test
	public void testGeneral_03() {
		String res = ConvertHandler.convertTo(2, 10.3333);
